...
bool Person::isEGNSame(int* otherEGN)
{
	for (int i = 0; i < EGN_SIZE; ++i)
	{
		if(EGN[i] != otherEGN[i])
...
bool Person::isPersonSame(Person& other)
{
	if(isEGNSame(other.getEGN()))
	{
		return (strcmp(firstName, other.getFirstName()) == 0) && (strcmp(middleName, other.getMiddleName()) == 0) && (strcmp(lastName, other.getLastName()) == 0);
	}
